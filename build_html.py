...
<meta name="apple-mobile-web-app-title" content="路跑賽事">
...
html,body{margin:0;padding:0;background:var(--bg);color:var(--fg);font-family:-apple-system,"PingFang TC","Noto Sans TC","Helvetica Neue",sans-serif;font-size:14px;line-height:1.5;-webkit-text-size-adjust:100%}
body{padding:env(safe-area-inset-top) env(safe-area-inset-right) env(safe-area-inset-bottom) env(safe-area-inset-left)}
a{color:var(--accent2);text-decoration:none}
a:hover{text-decoration:underline}
header{position:sticky;top:0;z-index:10;background:color-mix(in srgb,var(--bg) 94%,transparent);-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px);border-bottom:1px solid var(--border)}
...
.search{flex:1;min-width:200px;padding:10px 12px;border-radius:8px;border:1px solid var(--border);background:var(--panel);color:var(--fg);font-size:16px;-webkit-appearance:none;appearance:none}
...
.month-head{position:sticky;top:0;display:flex;align-items:baseline;gap:10px;margin:0 0 12px;padding:8px 0;background:color-mix(in srgb,var(--bg) 92%,transparent);-webkit-backdrop-filter:blur(8px);backdrop-filter:blur(8px);border-bottom:2px solid var(--accent);z-index:5}
...
@media (max-width:760px){
  ...
  .card{padding:12px}
  .name{font-size:14px}
  .star{font-size:24px;padding:0 4px;min-width:32px;min-height:32px}
